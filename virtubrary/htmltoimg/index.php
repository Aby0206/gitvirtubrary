...
<body>
	Hi
    <center style="max-width: 150px;overflow-y: scroll;max-height: 500px;">        
<?php
...
//session_start();
	...
	$sql = "SELECT DISTINCT(COL3) FROM `datasorted` ";

	//$sql = "SELECT COUNT(DISTINCT('COL3')) FROM `datasorted` WHERE 1";
...
?>
        <div id="html-content-holder<?php echo $i;?>" 
		<?php
		echo "style='min-height: 175px;background: linear-gradient(".mt_rand( 0, 360 )."deg,#".str_pad( dechex( mt_rand( 0, 255 ) ), 2, '0', STR_PAD_LEFT).str_pad( dechex( mt_rand( 0, 255 ) ), 2, '0', STR_PAD_LEFT).str_pad( dechex( mt_rand( 0, 255 ) ), 2, '0', STR_PAD_LEFT).","."#".str_pad( dechex( mt_rand( 0, 255 ) ), 2, '0', STR_PAD_LEFT).str_pad( dechex( mt_rand( 0, 255 ) ), 2, '0', STR_PAD_LEFT).str_pad( dechex( mt_rand( 0, 255 ) ), 2, '0', STR_PAD_LEFT).")'";
	    ?>
	    >           
	        <!-- <div class="output-color<?php echo $i?> card"> -->
...
<?php
	echo "<h3>".implode("<br>",explode(" ",$row["COL3"],3))."</h3><br><p> </p></div></div>";
	//echo implode("----",$row);
	  }
	} else {
	  echo "0 results";
...
?>
    ...
    <div>
	    ...
	    <button id="getnumber">Get Numbers</button>
	</div>
	<br>
	<div>
    ...
    <script>
    	...
    	document.getElementById("getnumber").addEventListener("click", ()=>{
    		ttlnum=document.getElementById('number').value??5;
    	});
		...
		function() {
			...
			while (i<ttlnum){
				i++;
				let thename="html-content-holder"+i;
				console.log(document.getElementById(thename))
						html2canvas(document.getElementById(thename),
						{
							allowTaint: true,
							useCORS: false
							...
							anchorTag.download = "filename"+thename+".jpg";
    ...
    <!-- ⚠️ Moved CSS and JS to their tabs -->
<!-- ⚠️ Changed ids with classes to make it more reusable -->
<!-- ⚠️ Changed some divs with more significat tags -->
...
<style type="text/css">
	/* ⚠️ Moved Google Font import here */
/* ⚠️ Changed px to rem and made them more consistent */
/* ⚠️ Moved colors to :root custom properties */
...
<script type="text/javascript">
	// ⚠️ Changed `let`s to `const`s
// ⚠️ Using `querySelector` instead of `getElementById`
// ⚠️ Added a bunch of JSDocs to improve DX
